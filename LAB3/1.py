...
# Linear regression
model = Sequential()
model.add(Dense(output_dim=1, input_shape=(13,), init='normal', activation='relu'))
...
#fitting the model
history=model.fit(X_train, Y_train, epochs=nb_epoch, batch_size=batch_size,callbacks=[tensorboard])
